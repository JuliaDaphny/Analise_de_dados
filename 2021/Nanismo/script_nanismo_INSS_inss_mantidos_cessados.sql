...
SELECT count(*) FROM search_columns('E343',array(select table_name::name from information_schema.tables where table_name like 'tb_mantidos_ativos_2020%'), array['inss_mantidos_ativos']);
